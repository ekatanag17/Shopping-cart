...
const Cart = ({id, description, title, img, pr}) => {
  return (
    <>
   ...
   <section className="main-cart-section">
      ...
      <div className="cart-items-container">
       <div className="items-info">
         <div className="product-img">
           <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSxg1yGODnMQU47VOxTzUwcEPM2beCrStgG6w&usqp=CAU" alt="image" />
       </div>
       ...
       <div className="price">
         ...
         <div className="add-minus-quantity">
           <button><i class="fas fa-minus minus"></i></button>
           <input type="text" placeholder="3" />
           <button><i class="fas fa-plus add" ></i></button>
       </div>
         <div className="itemprice">
         <h6>Item price $0.60*1=$0.60</h6>
       </div>
       
       <div className="itemcost">
         <h6>Item cost $0.60</h6>
       </div>
       </div>
     ...
     <div className="items-info">
         <div className="product-img">
           <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQBAkpfDEj41uZ3L7C9EWJsjgl7d7fOtHepXw&usqp=CAU" alt="image" />
       </div>
...
export default function Cart({ cart, setCart, productToadd, productToremove }) {
  const getTotalSum = () => {
    return cart.reduce(
  ...
  const setQuantity = (product, amount, productToadd, productToremove) => {
    const newCart = [...cart];
    newCart.find(
      ...
      <div className="products">
        {cart.map((product, idx) => (
          <div className="product" key={idx}>
            ...
            <button onClick={() => productToremove(product)} className="remove">
                -
            </button>{' '}
            <button onClick={() => productToadd(product)} className="add">
                +
              </button>
